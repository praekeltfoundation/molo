# -*- coding: utf-8 -*-
"""
Django settings for base mobi-application.
...
SECRET_KEY = "@w-ren98!i6h(25vps1#9&cvts*1z$f8(&hg^%b3=k2%u4u2oc"
...
ROOT_URLCONF = 'mobi-application.urls'
WSGI_APPLICATION = 'mobi-application.wsgi.application'
...
SITE_NAME = environ.get('SITE_NAME', "mobi-application")
