...
e.g.
.. image:: docs/bem-markup.png
    :target: https://en.bem.info/methodology/quick-start/
    :alt: BEM Methodology
...
.. image:: docs/smacss-setup.png
    :target: https://smacss.com/
    :alt: SMACSS Methodology
...
Website speed performance is done using software service tool - Dareboost to measure speed, analyze and monitor websites.

.. _`Benefits of Ways of Working`: http://ways-of-working.readthedocs.io/en/latest/process.html#our-front-end-development-process
----------------------------
