# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-09-04 09:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='bannerpage',
            name='translated_pages',
            field=models.ManyToManyField(blank=True, null=True, related_name='_bannerpage_translated_pages_+', to='core.BannerPage'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='reactionquestion',
            name='translated_pages',
            field=models.ManyToManyField(blank=True, null=True, related_name='_reactionquestion_translated_pages_+', to='core.ReactionQuestion'),
        ),
        migrations.AddField(
