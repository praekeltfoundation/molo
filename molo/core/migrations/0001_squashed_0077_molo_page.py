# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-01-31 19:30
...
class Migration(migrations.Migration):
    ...
    replaces = [
        (b'core', '0001_initial'),
        (b'core', '0002_create_homepage'),
        (b'core', '0003_articlepage_languagepage_main_sectionpage'),
        (b'core', '0004_configure_root_page'),
        (b'core', '0005_add_nullable_to_articlepage_sectionpage'),
        (b'core', '0006_add_help_text_to_language_code'),
        (b'core', '0007_articlepage_body'),
        (b'core', '0008_articlepage_add_more_blocks'),
        (b'core', '0009_sectionpage_image'),
        (b'core', '0010_add_banner_to_homepage'),
        (b'core', '0011_footerpage'),
        (b'core', '0012_add_featured_fields_to_articlepage'),
        (b'core', '0013_articlepage_featured_in_homepage'),
        (b'core', '0014_sectionpage_extra_style_hints'),
        (b'core', '0015_auto_20150925_1037'),
        (b'core', '0016_auto_20150925_1226'),
        (b'core', '0017_auto_20150925_1232'),
        (b'core', '0018_auto_20150925_1554'),
        (b'core', '0019_add_tags_to_article'),
        (b'core', '0020_add-social-media-fields-to-article-page'),
        (b'core', '0021_add-meta-tags-field-to-article-page'),
        (b'core', '0022_add_help_text_for_metadata_tags'),
        (b'core', '0023_languagepage_main_language'),
        (b'core', '0024_add_language_field_to_models'),
        (b'core', '0025_add_translation_model'),
        (b'core', '0026_add_site_language_model'),
        (b'core', '0027_remove_commenting_fields_from_homepage'),
        (b'core', '0028_rename_homepage_to_bannerpage'),
        (b'core', '0029_add_UUID_filed'),
        (b'core', '0030_change_related_name_for_translations'),
        (b'core', '0031_sitesettings'),
        (b'core', '0032_sitesettings_ga_tag_manager'),
        (b'core', '0033_bannerindexpage_footerindexpage_sectionindexpage'),
        (b'core', '0034_create_index_pages'),
        (b'core', '0035_content_rotation_settings'),
        (b'core', '0036_auto_add_related_section_to_article'),
        (b'core', '0037_add_article_body_media_field'),
        (b'core', '0038_sitesettings_global_ga_tag_manager'),
        (b'core', '0039_add_content_rotation_to_SectionPage'),
        (b'core', '0040_auto_20160722_1041'),
        (b'core', '0041_GA_tracking_code'),
        (b'core', '0042_content_rotation_dates_and_times'),
        (b'core', '0043_sitesettings_show_only_translated_pages'),
        (b'core', '0044_add_topic_of_the_day_fields'),
        (b'core', '0045_bannerpage_external_link'),
        (b'core', '0046_sitesettings_enable_clickable_tags'),
        (b'core', '0047_add_core_permissions_to_groups'),
        (b'core', '0048_promotion_dates'),
        (b'core', '0049_add_social_media_links_to_site_settings'),
        (b'core', '0050_data_migration_promoted_articles'),
        (b'core', '0051_remove_user_permission_for_moderator_group'),
        (b'core', '0052_update_permissions_for_groups'),
        (b'core', '0053_add_next_and_recommended_functionality'),
        (b'core', '0054_languages_sitelanguagerelation'),
        (b'core', '0055_migrate_current_site_languages_to_language_relation'),
        (b'core', '0056_tag_navigation'),
        (b'core', '0057_create_tag_index_page'),
        (b'core', '0058_section_tags'),
        (b'core', '0059_reaction_questions'),
        (b'core', '0060_reaction_questions_index_page'),
        (b'core', '0061_add_success_fields_to_reaction_choice'),
        (b'core', '0062_increase_char_length_reaction_success'),
        (b'core', '0063_articlepagelanguageproxy'),
        (b'core', '0064_auto_20170802_1410'),
        (b'core', '0065_auto_20170807_1005'),
        (b'core', '0066_add_custom_media_model'),
        (b'core', '0067_promote_homepage_media'),
        (b'core', '0068_media_migration'),
        (b'core', '0069_add_image_info'),
        (b'core', '0070_add_service_directory_api'),
        (b'core', '0071_remove_old_image_hashes'),
        (b'core', '0072_fb_tracking_id'),
        (b'core', '0073_run_wagtail_migration_before_core_34'),
        (b'core', '0074_banner_subtitle'),
        (b'core', '0075_create_timezone'),
        (b'core', '0076_create_cmssettings'),
        (b'core', '0077_molo_page')
    ]
