# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2017-01-27 11:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text=b"Activate up next section underneath articles in this         section will apear with the heading and subheading of that article.         The text will say 'next' in order to make the user feel like it's         fresh content.", verbose_name=b'Activate up next section underneath articles'),
        ),
        migrations.AddField(
            model_name='sectionpage',
            name='enable_recommended_section',
            field=models.BooleanField(default=False, help_text=b"Underneath the area for 'next articles 4 recommended         articles will appear, with the image + heading + subheading", verbose_name=b'Activate recommended section underneath articles'),
        ),
    ]
