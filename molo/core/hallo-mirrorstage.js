...
function processpaste (elem, savedcontent) {
    ...
    document.execCommand("insertHTML", false, html2text(pasteddata));
...
$(document).ready(function(){
    "use strict";
    $('#id_subtitle').parent().prepend('<div id="subtitle_markdown" contenteditable="true" class="editable isModified" onpaste="handlepaste(this, event)"></div><script>$("#subtitle_markdown").autosize();</script>');
    //$('#id_subtitle').css("display","none");
    // $("#subtitle_markdown").bind("paste", function(e) {
    //   console.log("first");
    //   // cancel paste
    //   e.preventDefault();
    //   console.log("second");
...
jQuery(document).ready(function() {
  ...
  var showSource = function(content) {
    ...
    if (jQuery('#id_subtitle').get(0).value == markdown) {
      return;
    }
    jQuery('#id_subtitle').get(0).value = markdown;
  };
  ...
  jQuery('#id_subtitle').bind('keyup', function() {
...
// event listener
// $(document).ready(function(){
//   $('.action-add-block-paragraph').on( "click", buttonListener);
//   $('.action-add-block-list').css("color","red");
//   //$('.action-add-block-list').on( "click", buttonListener2);
//   $('.action-add-block-numbered_list').on( "click", buttonListener);
// });
$('document').ready(function() {
  $('body').on('DOMNodeInserted', 'button', function () {
