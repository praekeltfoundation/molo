# -*- coding: utf-8 -*-
"""
Django settings for base mobiApp.
...
SECRET_KEY = "c4hh1xd3rn*4gbx(!w!3)2!z$nid(%w(@ig)&qvbc(as)_7m=1"
...
ROOT_URLCONF = 'mobiApp.urls'
WSGI_APPLICATION = 'mobiApp.wsgi.application'
...
SITE_NAME = environ.get('SITE_NAME', "mobiApp")
